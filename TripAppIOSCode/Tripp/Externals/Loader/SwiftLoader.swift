...
open class SwiftLoader: UIView {
    ...
    open class func showNativeIndicator() {
        ...
        if let app = UIApplication.shared.delegate as? AppDelegate, let window = app.window {
            ...
            loader.activityIndicatorView.activityIndicatorViewStyle = .whiteLarge
            ...
            window.addSubview(loader.activityIndicatorView)
    ...
    open class func hideNativeIndicator() {
    ...
    public struct Config {
        ...
        public init() {DLog(message: "swiftyloader" as AnyObject)}
